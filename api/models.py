...
class SystemLoadRequest(BaseModel):
    ...
    upsampler_path: Optional[str] = Field(None, description="Path to the upsampler. Leave empty to auto-download.")
    gemma_path: Optional[str] = Field(None, description="Path to gemma dir. Leave empty to auto-download.")
    quantization: str = Field(default="none", description="'none', 'fp8-cast', or 'fp8-scaled-mm'")
